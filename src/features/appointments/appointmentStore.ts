...
function normalizeAppointment(appointment: Appointment): Appointment {
  return {
    ...
    proposedProviderId: appointment.proposedProviderId,
    providerAcceptedAt: appointment.providerAcceptedAt,
    providerAcceptedBy: appointment.providerAcceptedBy,
    providerDeclinedAt: appointment.providerDeclinedAt,
    providerDeclinedBy: appointment.providerDeclinedBy,
...
function mapAppointmentToRemoteRow(appointment: Appointment) {
  return {
    ...
    proposed_provider_id: appointment.proposedProviderId || null,
    provider_accepted_at: appointment.providerAcceptedAt ?? null,
    provider_accepted_by: appointment.providerAcceptedBy ?? null,
    provider_declined_at: appointment.providerDeclinedAt ?? null,
    provider_declined_by: appointment.providerDeclinedBy ?? null,
