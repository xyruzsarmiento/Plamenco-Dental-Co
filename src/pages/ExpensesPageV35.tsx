...
import { ExpenseTrendV68 } from '../components/ui/ExpenseTrendV68'
...
export function ExpensesPageV35() {
  ...
  return <section className="expenses35-shell">
    ...
    <div className="analytics35-grid expenses35-analytics expenses56-analytics">
      <section className="analytics35-card analytics35-wide expenses35-trend-card expenses68-trend-card"><header><span>Cost trend</span><h3>Operating cost trend</h3><p>Monthly recorded operating expenses for the current clinic year. Hover or keyboard-focus a month to inspect the exact amount.</p></header><ExpenseTrendV68 rows={monthlyTrend} formatter={formatReportCurrency} /></section>
