...
import { ExpenseTrendV74 } from '../components/ui/ExpenseTrendV74'
...
export function ExpensesPageV35() {
  ...
  return <section className="expenses35-shell">
    ...
    <div className="analytics35-grid expenses35-analytics expenses56-analytics">
      <section className="analytics35-card analytics35-wide expenses35-trend-card expenses74-trend-card"><header><div><span>Cost trend</span><h3>Operating cost trend</h3><p>Interactive monthly operating-cost movement for the current clinic year. Hover or keyboard-focus any month to inspect its exact recorded amount.</p></div></header><ExpenseTrendV74 rows={monthlyTrend} formatter={formatReportCurrency} /></section>
