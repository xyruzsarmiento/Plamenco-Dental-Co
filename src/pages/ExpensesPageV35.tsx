...
import { ExpenseMonthlyBarsV75 } from '../components/ui/ExpenseMonthlyBarsV75'
...
export function ExpensesPageV35() {
  ...
  return <section className="expenses35-shell">
    ...
    <div className="analytics35-grid expenses35-analytics expenses56-analytics">
      <section className="analytics35-card analytics35-wide expenses75-monthly-card"><header><div><span>Monthly operating costs</span><h3>Cost distribution</h3><p>Recorded operating expenses by month for the current clinic year. Hover or keyboard-focus a bar to inspect the exact amount.</p></div></header><ExpenseMonthlyBarsV75 rows={monthlyCosts} formatter={formatReportCurrency} /></section>
