...
import { BilledValueByServiceV50, MostAvailedServicesV50 } from '../components/ui/ServiceAnalyticsV50'
        ...
        <div className="services49-analytics-grid">
          <article className="services49-analytics-card is-demand">
            ...
            <div className="services49-chart-frame">
              <MostAvailedServicesV50 rows={analyticsRows} />
            </div>
          </article>
          ...
          <article className="services49-analytics-card is-value">
            ...
            <div className="services49-chart-frame">
              <BilledValueByServiceV50 rows={analyticsRows} />
            </div>
          </article>
        </div>
      </section>
