-- Secure public booking through one narrowly-scoped server-side RPC.
-- Direct anonymous table writes remain disabled.
...
begin
  ...
  insert into public.appointments (
    ...
    to_char(p_start_time::time,'HH24:MI'), v_end_time, v_service.duration, round(v_service.price)::integer,
