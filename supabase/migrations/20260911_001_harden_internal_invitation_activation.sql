-- Keep internal account activation bound to the invitation's persisted role and
-- provisioned clinic records. The whole function runs as one database transaction.
