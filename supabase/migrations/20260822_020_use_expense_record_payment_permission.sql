-- Use the existing dedicated expense-payment permission instead of the broader
-- expense-create permission while preserving the hardened atomic payment RPC.
...
begin
  ...
  if not public.has_profile_permission('expenses.record_payment') then
